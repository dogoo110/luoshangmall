...
<c:forEach items="${orderList}" var="order">
			...
			<dd>
				订单编号：${order.orderId }<br />
				 ...
				 <c:if test="${order.orderPaystate==0 }" var="flag">
						...
						<a href="${app}/order/deleteOrder/${order.orderId}"><img src="http://image.luoshangmall.cn/sc.jpg" width="69" height="19"></a> 
				 		<a href="${app}/pay/imageEm/${order.userId}/${order.orderId}"> <img src="http://image.luoshangmall.cn/zx.jpg" width="69" height="19"></a><br /> 
				 </c:if>
				 <c:if test="${!flag }">
		...
		<table width="1200" border="0" cellpadding="0"
			...
			<tr>
				<th width="200" height="30" align="center" valign="middle" bgcolor="#f3f3f3">商品图片</th>
				<th width="200" align="center" valign="middle" bgcolor="#f3f3f3">商品名称</th>
				<th width="200" align="center" valign="middle" bgcolor="#f3f3f3">商品码数</th>
				<th width="200" align="center" valign="middle" bgcolor="#f3f3f3">商品单价</th>
				<th width="200" align="center" valign="middle" bgcolor="#f3f3f3">购买数量</th>
				<th width="200" align="center" valign="middle" bgcolor="#f3f3f3">小计</th>
			</tr>
		<c:set var="money" value="0"/>
		<c:forEach items="${order.orderItems}" var="product">
			<tr>
				<td align="center" valign="middle" bgcolor="#FFFFFF">
					<img src="http://image.luoshangmall.cn/${product.productImage }" width="90" height="105">
				</td>
				<td align="center" valign="middle" bgcolor="#FFFFFF">${product.productName}</td>
				<td align="center" valign="middle" bgcolor="#FFFFFF">${product.size}码</td>
				<td align="center" valign="middle" bgcolor="#FFFFFF">${product.productPrice}元</td>
				<td align="center" valign="middle" bgcolor="#FFFFFF">${product.num}件</td>
