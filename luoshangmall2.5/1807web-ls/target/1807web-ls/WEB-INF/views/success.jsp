...
<head>
  ...
  <link rel="stylesheet" href="${app}/css/normalize.css">
    ...
    <link rel="stylesheet" href="${app}/css/styleSu.css" media="screen" type="text/css" />
...
<div class="help" style="opacity: 0">?</div> 
...
<div class="overlay">
  ...
  <script src="${app}/js/index.js"></script>
	 ...
	 <%response.setHeader("refresh","8;url=http://web.luoshangmall.cn");%> 
</html>