...
<table class="easyui-datagrid" id="itemList" title="商品列表" 
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'categoryName',width:100">商品类目</th>
            <th data-options="field:'brandName',width:100">商品品牌</th>
            <th data-options="field:'productStatus',width:100">上架状态</th>
            <th data-options="field:'s',width:70">S</th>
            <th data-options="field:'l',width:70">L</th>
            <th data-options="field:'x',width:70">X</th>
            <th data-options="field:'xl',width:70">XL</th>
            <th data-options="field:'xxl',width:70">XXL</th>
